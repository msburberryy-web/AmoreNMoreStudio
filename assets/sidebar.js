(function () {
  ...
  style.textContent = '\
    ...
    .am-sb-ey .sb-my { font-family:"Noto Serif Myanmar",serif; letter-spacing:1px; }\
    ...
    .am-sb-nav .sb-my { font-family:"Noto Serif Myanmar",serif; letter-spacing:0; text-transform:none; font-size:13px; }\
    .am-sb-rule {\
    ...
    .am-sb-ll .sb-my { font-family:"Noto Serif Myanmar",serif; letter-spacing:0.5px; text-transform:none; }\
    .am-sb-lb {\
      font-size:11px;\
    ...
    .am-sb-lb[data-l="my"] { font-family:"Noto Serif Myanmar",serif; letter-spacing:0; }\
    ...
    #am-pg-foot p .sb-my { font-family:"Noto Serif Myanmar",serif; letter-spacing:0.5px; text-transform:none; }\
